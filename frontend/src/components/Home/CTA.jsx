    ...
    <section className="relative max-w-[1366px] mx-auto z-20">
      ...
      >
        ...
        <div className="relative z-10 space-y-6 max-w-4xl mx-auto">
          ...
          <div className="pt-4">
            <button className="bg-neutral-6 hover:bg-white text-[#0D0A14] font-bold px-12 py-4.5 rounded-full shadow-[0_10px_35px_rgba(0,0,0,0.3)] hover:scale-105 transition-all text-lg cursor-pointer">
              Mulai Sekarang
            </button>
          </div>
        </div>
